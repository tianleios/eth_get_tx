 ...
 * <修改描述:>
 */
package com.cdkj.coin.dao.base.handler;
...
public class JdbcUtils {
    ...
    public static int getSqlTypeByJavaType(Class<?> type) {
        ...
        Assert.isTrue(SIMPLE_TYPE_2_TYPES_MAP.containsKey(type),
            "unsupport type:" + type + ". not simple type.");

        return SIMPLE_TYPE_2_TYPES_MAP.get(type);
    }

    /**
     * 根据javaType获取对应的ibatis中定义的jdbcType <功能详细描述>
     * 
     * @param type
     * @return [参数说明]
     * 
    ...
    public static void setPreparedStatementValueForSimpleType(
        ...
        Assert.notNull(typeHandler, "type:" + type + " is not typeHandler");
