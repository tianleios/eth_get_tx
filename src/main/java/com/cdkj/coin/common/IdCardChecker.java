/**
 * @Title IdCardChecker.java 
 * @Package com.hsnet.pz.api 
 * @Description 
 * @author miyb  
 * @date 2015-4-13 上午10:23:01 
 * @version V1.0   
 */
...
public class IdCardChecker {
     ...
     * @return
     */
    public IdCardChecker(String cardNumber) {
        if (null != cardNumber) {
     ...
     * 15位身份证无最后一位校验码。18位身份证中，校验码根据根据前17位生成<br>
     * @param cardNumber
     * @return
     */
    private static String contertToNewCardNumber(String oldCardNumber) {
        ...
        buf.append(IdCardChecker.calculateVerifyCode(buf));
        return buf.toString();
    }
